...
/**
 * Auto-generated migration regression guard for plugin "hypegeo".
 *
...
final class MigrationRegressionTest extends TestCase
{
    ...
    /**
     * Source of $file with every comment blanked out, newlines preserved so line
     * numbers still line up with the file on disk.
     *
     * The removed-symbol scanners below are textual, so without this they flag
     * mentions of a removed function in a docblock or a `// TODO(7.x): foo()
     * removed` breadcrumb as though they were live call sites. Comments cannot
     * fatal at runtime; only executable code can.
     */
    private static function codeOnlySource(string $file): string
    {
        $out = '';
    ...
    public function testNoRemovedSymbols(): void
    {
        ...
        foreach (self::files('', 'php') as $file) {
            ...
            foreach (explode("\n", self::codeOnlySource($file)) as $n => $line) {
    ...
    public function testNoRemovedConstants(): void
    {
        ...
        foreach (self::files('', 'php') as $file) {
            ...
            if (preg_match_all($re, self::codeOnlySource($file), $m)) {
